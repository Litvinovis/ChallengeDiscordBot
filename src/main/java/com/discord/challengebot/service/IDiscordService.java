...
public interface IDiscordService {
	...
	/**
	 * Формирует и отправляет ежедневный отчёт о прогрессе активных испытаний.
	 * Отчёт пропускается, если активных испытаний нет или за последние сутки
	 * никто не вносил прогресс — чтобы канал не получал одинаковые сводки.
	 */
